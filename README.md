...
> Reviews-App-React is a React project styled with Tailwind CSS, using Prettier for cleaner code, and utilizing hooks such as useEffect and useState. Download the project or check out the sample images for a better look.
